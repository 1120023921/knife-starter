 ...
 */
public class AceSocialLoginTenantFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public AceSocialLoginTenantFilter(AuthenticationManager authenticationManager, RedisTemplate<String, AceUser> userDetailRedisTemplate, RedisTemplate<String, AceOAuth2AccessToken> tokenRedisTemplate, AceSecurityConfigProperties aceSecurityConfigProperties, ObjectMapper objectMapper) {
